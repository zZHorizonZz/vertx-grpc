import io.vertx.mcp.server.impl.ModelContextProtocolHttpInvoker;
...
module io.vertx.mcp.bridge.grpc {
  ...
  provides io.vertx.grpc.server.impl.GrpcHttpInvoker with ModelContextProtocolHttpInvoker;
}
