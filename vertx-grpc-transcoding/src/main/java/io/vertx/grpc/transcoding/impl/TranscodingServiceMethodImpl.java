...
public class TranscodingServiceMethodImpl<I, O> implements TranscodingServiceMethod<I, O>, MountPoint<I, O> {
  ...
  public GrpcInvocation accept(HttpServerRequest httpRequest) {
    ...
    if (res != null) {
      ...
      TranscodingMessageDecoder<I> messageDecoder = new TranscodingMessageDecoder<>((io.vertx.grpc.protobuf.ProtobufMessageDecoder<I>) decoder, res.getBodyFieldPath(), bindings);
