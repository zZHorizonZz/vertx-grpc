package io.vertx.tests.mcp.bridge.grpc;
...
public class ModelContextProtocolBridgeTest {
  ...
  public void setUp(TestContext ctx) {
    ...
    // Create MCP service
    ModelContextProtocolServer mcpService = ModelContextProtocolServer.create(new ModelContextProtocolOptions());
  ...
  public void testBridgeWithoutHttpClient(TestContext ctx) {
    ...
    ModelContextProtocolServerImpl mcpService = new ModelContextProtocolServerImpl(vertx);
  ...
  private Future<JsonRpcResponse> sendJsonRpcRequest(JsonRpcRequest request) {
    return httpClient.request(HttpMethod.POST, "/io.modelcontextprotocol.ModelContextProtocolServer")
      .compose(req -> {
